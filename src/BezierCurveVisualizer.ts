...
export default class BezierCurveVisualizer {
    ...
    public update(curve: THREE.CubicBezierCurve | THREE.QuadraticBezierCurve) {
    ...
    private updateControlPoints(curve: THREE.CubicBezierCurve | THREE.QuadraticBezierCurve) {
        // Determine the control points
        const controlPoints = (curve instanceof THREE.CubicBezierCurve)
